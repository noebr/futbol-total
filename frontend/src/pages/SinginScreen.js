    ...
    <form onSubmit={submitHandler} className='container-login-form'>
      <div className="form-container">
        ...
        <div className="datos-forms">
          ...
          <br/><br/><p>o</p><br/><br/>
          <button className='button-azul-redes'><img src='/imagenes/facebook1.png'className="redes-sociales-facebook" alt="facebook" /> Continuar con Facebook</button>
			<br/><br/>
			<button className='button-azul-redes'><img src='/imagenes/gmail.png'className="redes-sociales-gmail" alt="facebook" /> Continuar con Gmail</button>
          </div>
          <div className='login-olvidaste'>
				<Link className='login-olvidaste'to='/codigo'>¿Olvidaste tu Contraseña?</Link>
			</div>
      </div>
    </form>
  </div>
