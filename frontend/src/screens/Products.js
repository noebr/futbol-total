        ...
        <Fade bottom cascade={true}>
          {!this.props.products ? (
                ...
                {this.props.products.map((product) => (
                  <li key={product._id}>
                    <div className="product">
                      ...
                      <Link className="link-name" to={"#" + product._id} onClick={() => this.openModal(product)}>
           ...
           Ver más...  </Link>
                      ...
                      <br />
                      <br />
                      <button onClick={() => this.props.addToCart(product)} className="button-transparente-ac">
                      <img src='/imagenes/carrito-8.png' alt="carrito" className="carrito"/>
                      </button>
                    </div>
                  </li>))
                }
                ...
                <div className="product-details-description">
                  ...
                  <div className="product-price">
                    ...
                    <div>
                      ...
                      <Modal2/>
                      <br /><br />
                      <button className="button-transparente-forms" onClick={() => {
